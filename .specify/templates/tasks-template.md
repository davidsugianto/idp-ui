...
- **Single project frontend app**: `src/`, `src/__tests__/integration/`, `src/components/`, `src/pages/`, `src/services/`, `src/stores/`
- **Web app split repo**: `backend/src/`, `frontend/src/`
- **Mobile**: `api/src/`, `ios/src/` or `android/src/`
- Paths shown below assume a single-project frontend app unless plan.md says otherwise
